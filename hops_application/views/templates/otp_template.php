<html>
  ...
  <body>
    <div style="background-color:#fff;width: 600px;margin: 0 auto; border:1px solid #ddd;padding:10px;">
      <div style="background-color:#99DFF9;padding: 5px 10px;">
        <img src="http://temp1.pickzy.com/hops/assets/images/logo.png" alt="Logo" title="Logo" style="height: 100px;display: block;float: left" /> 
